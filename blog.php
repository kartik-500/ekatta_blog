...
$q1='SELECT COUNT(*) as cntse
FROM blog WHERE 1';
$resul1 = mysqli_query($db,$q1);
        $ro1 = mysqli_fetch_array($resul1);
        $coun1 = ceil($ro1['cntse']/5);
...
<?php
/*if($uri=="/ekatta_blog_project/blog.php")
{
$query='SELECT * FROM `blog` WHERE 1 ORDER BY blogid DESC LIMIT 5';
}
else
{
$query='SELECT * FROM `blog` WHERE blogid< '.$blogid.' ORDER BY blogid DESC LIMIT 5';
}*/
$query2="SELECT * FROM (
...
if($index>0){$rq=$index-1;}
if ($index==0) {$rq=0;}
  $query='SELECT * FROM `blog` ORDER BY blogid DESC LIMIT 5 OFFSET '.($rq*5).'';
...
?>
                        ...
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="single-blog.php?blogid=<?= $blogid?>">
                        ...
                        <nav class="blog-pagination justify-content-center d-flex">
                            <ul class="pagination">
                                ...
                                echo'<li class="page-item">
                                    <a href="blog.php?index='.($index-1).'" class="page-link" aria-label="Previous">
                                ...
                                while($index!=$coun1+1){
                                echo'<li class="page-item">
                                    <a href="blog.php?index='.$index.'" class="page-link">'.$index.'</a>
                                </li>';
                                $index++;
                                }
                                if($index>$coun1){
                                echo'<li class="page-item">
                                    <a href="blog.php?index='.($index-1).'" class="page-link" aria-label="Next">
