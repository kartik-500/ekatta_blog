...
@$userId=$followingdata['userId'];
      ...
      $author_name=$ro[0];
$title=$followingdata['blogTitle'];
$description=$followingdata['blogContent'];
$date=$followingdata['timestamp'];
$image=$followingdata['blogImage']
?>
            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                      <?php echo'<img src="'.$image.'" class="card-img rounded-0"/>  ' ?>
                  </div>
                  <div class="blog_details">
                     <h2><?= $title?>
                     </h2>
                     <ul class="blog-info-link mt-3 mb-4">
                        <li><a href="#"><i class="far fa-user"></i> <?= $author_name?></a></li>
                        <li><a href="#"><i class="far fa-comments"></i> 03 Comments</a></li>
                     </ul>
                     <p class="excert"><?= $description?>
                     </p>
